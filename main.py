"""
Ai Story Generator
GPT-2 powered story generator with genre and style control
...
def main():
    print("=" * 65)
    print(f"  Ai Story Generator")
    print("=" * 65)
    print(f"  GPT-2 powered story generator with genre and style control")
    print()
